...
contract TimeVault is Timelock, Ownable {
    ...
    address public router = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // JoeRouter02
    ...
    constructor(uint256 _timelock_delay) Timelock(_msgSender(), _timelock_delay) {
        // initial token list
        tokenList[time] = true;
        tokenList[0xd586E7F844cEa2F87f50152665BCbc2C279D8d70] = true; // DAI
        tokenList[0x130966628846BFd36ff31a822705796e8cb8C18D] = true; // MIM
    }
    ...
    function stake(uint256 _amount) external onlyOwner {
        // approve
        IERC20(time).safeApprove(staking, _amount);
        ...
        // revoke
        IERC20(time).safeApprove(staking, 0);
