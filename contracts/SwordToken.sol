...
contract SwordToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Sword Token", "SWORD", 9) ERC20Permit() {
    ...
    /**
        @notice increases SWORD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SWORD
